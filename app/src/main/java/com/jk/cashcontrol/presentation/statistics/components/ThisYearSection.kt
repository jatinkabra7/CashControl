...
fun ThisYearSection(
    ...
    val topIncomeCategoryIcon =incomeCategories.find { it.name == state.thisYearTopIncomeCategory }!!.icon
    val topExpenseCategoryIcon =incomeCategories.find { it.name == state.thisYearTopExpenseCategory }!!.icon
