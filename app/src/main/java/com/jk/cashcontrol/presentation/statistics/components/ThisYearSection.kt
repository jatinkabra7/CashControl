...
fun ThisYearSection(
    ...
    val topIncomeCategoryIcon =incomeCategories.find { it.name == state.thisYearIncomeCategory }!!.icon
    val topExpenseCategoryIcon =incomeCategories.find { it.name == state.thisYearExpenseCategory }!!.icon
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = "Top Income - ${state.thisYearIncomeCategory}",
                fontSize = 20.sp,
                color = Color.White,
        ...
        Row(
            ...
            Text(
                text = "Top Expense - ${state.thisYearExpenseCategory}",
                fontSize = 20.sp,
                color = Color.White,
                fontWeight = FontWeight.Bold
            )
